                ...
                <div className="grid grid-cols-4 gap-6">
                  ...
                  <SimpleDropDown
                    ...
                    values={[
                      ...
                      { id: "1", label: person.firstName },
                      { id: "2", label: person.lastName },
                      { id: "3", label: person.nickName },
                    ].filter((it) => it.label)}
                    value={{ id: "1", label: person.firstName }}
                    onChange={(element) =>
                      console.log("selected displayName: ", element.label)
                    }
                  />
                  <GenderInput
                    disabled={false}
